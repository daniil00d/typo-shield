...
export interface TypoShieldListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `TypoShieldParser.dtos`.
	 * @param ctx the parse tree
	 */
	enterDtos?: (ctx: DtosContext) => void;
	/**
	 * Exit a parse tree produced by `TypoShieldParser.dtos`.
	 * @param ctx the parse tree
	 */
	exitDtos?: (ctx: DtosContext) => void;
